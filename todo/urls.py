...
urlpatterns = [
    ...
    path('<int:pk>/done_form', views.DoneQuest2.as_view(), name='done_form'),
    ...
    path('search_victory', views.search_victory, name='search_victory'),
    path('search_purpose', views.search_purpose, name='search_purpose'),
